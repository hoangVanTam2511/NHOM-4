...
//        loadThongKe(month, year);
        Date ngayBatDau = this.txtThongKeNgayBatDau.getDate();// Ngay bắt đầu dnhâ thống kê
        Date ngayKetThuc = this.txtThongKeNgayKetThuc.getDate();// Ngay két htức thống kê
