...
import responsitiories.impl.NhaSanXuatReponsitoryImpl;
...
public class NhaSanXuatServiceImpl implements IService<QlNhaSanXuat> {
    ...
    private NhaSanXuatReponsitoryImpl nhaSanXuatReponsitoryImpl;
    private List<QlNhaSanXuat> listNhaSanXuat;

    public NhaSanXuatServiceImpl() {
        this.nhaSanXuatReponsitoryImpl = new NhaSanXuatReponsitoryImpl();
    }
